            ...
            <div className="row">
              ...
              <p className="right">
                <Trans i18nKey="products.monitor.first.subText">
                  The Binos Monitor is a low-cost air quality device configured
                  to measure particulate matter PM<sub>2.5</sub> and PM
                  <sub>10</sub>, the most common pollutants in African cities.
                  It also measures ambient meteorological conditions such as
              ...
              >
                ...
                <p>
                  <Trans i18nKey="products.monitor.second.subText">
                    ...
                    challenges like extreme weather conditions including high
                    levels of dust and heat typical to the context of African
                    cities. <br />
                    <br />
                    Powered by either mains or solar, the device is optimised to
                    work in settings characterised by unreliable power and
                    intermittent internet connectivity. It runs on a 2G GSM
                    network configuration for IoT sim cards.
                    <br />
                  </Trans>
                  <a
              ...
              >
                ...
                <p>
                  <Trans i18nKey="products.monitor.third.subText">
                    ...
                    buildings or motor-cycle taxis locally called 'boda-bodas'
                    to improve spatial coverage and revolution. <br /> <br />
                    Air quality data collection using motorcycle taxis has real
                    potential for high-resolution air quality monitoring in
                    urban spaces. Mobile monitoring enables us to close the gaps
                    and spatial limitations of fixed static monitoring.
                  </Trans>
                </p>
              </div>
              ...
              >
                ...
                <p>
                  <Trans i18nKey="products.monitor.fourth.subText">
                    To effectively tackle air pollution, access to data and
                    contextual evidence is important to show the scale and
                    magnitude of air pollution. <br />
                    <br />
                    We’re providing an end-end air quality solution in major
                    African Cities leveraging the locally built low-cost
                    monitors and existing expertise to advance air quality
                    management and, implicitly, air quality improvement in these
                    African cities.
                  </Trans>
                </p>
              </div>
              ...
              >
                ...
                <p>
                  <Trans i18nKey="products.monitor.sixth.subText">
                    ...
                    <br /> + How to install the monitor <br /> + How to access
                    the data using our analytics dashboard
                  </Trans>
                </p>
                <a
                  href={UserGuide}
