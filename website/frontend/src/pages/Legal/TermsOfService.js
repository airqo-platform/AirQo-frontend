...
const TermsOfService = () => {
  ...
  const show = () => {
    ...
    if (!showMore) {
      for (let i = 0; i <= 11; i++) {
        getIds[i].style.display = 'none';
      }
    } else {
      for (let i = 0; i <= 11; i++) {
        getIds[i].style.display = 'contents';
      }
      ...
      <div className="content">
        <div className="tos-sub">
          <div className="sidenav">
            ...
            <div>
              <a href="#ltup">Licence to use platform</a>
            </div>
            <div>
              <a href="#au">Acceptance Use</a>
            </div>
            <div>
              <a href="#raa">Registration and Accounts</a>
            </div>
            <div>
              <a href="#uld">User Login Details</a>
            </div>
            <div>
              <a href="#casof">Cancellation & Suspension of account</a>
            </div>
            <div>
              <a href="#ycl">Your Content: Licence</a>
            </div>
            <div>
              <a href="#lw">Limited Warranties</a>
            </div>
            <div>
              <a href="#lae">Limitations & Exclusions</a>
            </div>
            <div>
              <a href="#botc">Breaches of these Conditions</a>
            </div>
            <div>
            ...
            <div>
              <a href="#tpr">Third Party Rights</a>
            </div>
            <div>
              <a href="#ea">Entire Agreement</a>
            </div>
            <div>
              <a href="#laj">Law and Jurisdiction</a>
            </div>
            <div>
              <a href="#details">Our Details</a>
            </div>
          </div>
          <div className="tos-wording">
            <div id="intro" className="show-first">
              ...
              <ol>
                <li>
                  Some cities already have programs for air quality monitoring, so we collaborate
                  with them on how to increase their coverage network.{' '}
                </li>
                <li>
                  By using our platform, you accept these terms and conditions in full; accordingly,
                  if you disagree with these terms and conditions or any part of these terms and
                  conditions, you must not use our platform.
                </li>
                <li>
                  If you register with our platform, submit any material to our platform or use any
                  of our platform services, we will ask you to expressly agree to these terms and
                  conditions.
                </li>
                <li>
            ...
            <div id="copyright" className="show-first">
              ...
              <ol>
                ...
                <p>
                  b. All the copyright and other intellectual property rights in our platform and
            ...
            <div id="ltup" className="show-first">
              ...
              <ol>
                ...
                <li>
                  If observational data are used for analyses, displayed on web pages, or used for
                  other programs or products, the analysis results, displays, or products must
                  indicate that these data are indicative and not fully verified or validated;
                </li>
                <li>
                  Publications, analyses, products, presentations, and/or derived information that
                  rely on these data must give attribution to the originating data provider named on
                  the data as well as AirQo, subject to the other provisions of these terms and
                  conditions.
                </li>

                <p>
                  <b>4.2 You may only use our platform for your own personal use,</b> academic
                  research, government policy research and development, charitable and public
                  awareness raising, and you must not use our platform for any other purposes.
                </p>

                <p>
                  <b>4.4 Except as expressly permitted by these terms and conditions,</b> you must
                  not edit or otherwise modify any material on our platform.
                </p>
                ...
                <p>
                  ...
                  <br />
                  republish material from our platform (including republication on another
                  platform); sell, rent or sub-license material from our platform; or exploit
                  material from our platform for a commercial purpose.
                </p>

                <p>
                  <b>4.6 Notwithstanding Section 4.5,</b> you may redistribute our newsletter or
                  blog posts in print and electronic form to any person.
                </p>

                <p>
                  <b>4.7 We reserve the right to restrict access to areas of our platform,</b> or
                  indeed our whole platform, at our discretion; you must not circumvent or bypass,
                  or attempt to circumvent or bypass, any access restriction measures on our
                  platform.
                </p>
              </ol>
            </div>
            <div id="au" className="show-first">
              ...
              <ol>
                ...
                <li>
                  use our platform in any way or take any action that causes, or may cause, damage
                  to the platform or impairment of the performance, availability or accessibility of
                  the platform;
                </li>
                <li>
                  use our platform in any way that is unlawful, illegal, fraudulent or harmful, or
                  in connection with any unlawful, illegal, fraudulent or harmful purpose or
                  activity;
                </li>
                <li>
                  use our platform to copy, store, host, transmit, send, use, publish or distribute
                ...
                <li>
                  ...
                  relation to our platform without our express written consent or via registered use
                  of our API or other data export, visualisation export or reporting tools provided
                  for this purpose on our platform.
                </li>
                <li>
                ...
                <li>
                  You must not use data collected from our platform to contact individuals,
                  companies or other persons or entities unless specific links or contact details
                  have been provided on the platform.
                </li>
              </ol>
            </div>
            <div id="raa" className="show-first">
              ...
              <ol>
                <li>
                  ...
                  account registration form on our platform, and clicking on the verification link
                  in the email that the platform will send to you.
                </li>
                <li>
                  You must ensure that all the information you supply to us through our platform in
                  relation to your intended use of our content and your affiliations is true,
                ...
                <li>
                  You must not use any other person's account to access the platform, unless you
            ...
            <div id="uld" className="show-first">
              ...
              <ol>
                <li>
                  If you register for an account with our platform, we will provide you with, or you
                ...
                <li>
                  You are responsible for any activity on our platform arising out of any failure to
            ...
            <div id="ycl" className="show-more">
              ...
              <ol>
                ...
                <li>
                  ...
                  rights, and must not be capable of giving rise to legal action against any person
                ...
                <li className="bulleted">
                  infringe any copyright, moral right, database right, trade mark right, design
            ...
            <div id="lw" className="show-more">
              ...
              <ol>
                <li>
                  ...
                  <br />
                  the completeness or accuracy of the information published on our platform. The
                  data available on the platform are indicative and while efforts are made to
                  provide accurate data they are not fully verified or validated; these data are
                  subject to change, error, and correction. The data and information are not
                  presented as an official record
                  <br />
                  <br />
                  the functionality or reliability of products in development and labelled as ‘beta’
                  versions which are released for trial purposes only and may be discontinued at any
                  time;
                  <br />
                  <br />
                ...
                <li>
                  We reserve the right to discontinue or alter any or all of our platform services,
                  and to stop publishing our platform, at any time in our sole discretion without
                  notice or explanation; and save to the extent expressly provided otherwise in
                  these terms and conditions, you will not be entitled to any compensation or other
                  payment upon the discontinuance or alteration of any platform services, or if we
                ...
                <li>
                  ...
                  terms and conditions, our platform and the use of our platform.
                </li>
              </ol>
            </div>
            <div id="lae" className="show-more">
              ...
              <ol>
                ...
                <p>
                  The limitations and exclusions of liability set out in this Section 12 and
                ...
                <p>
                  To the extent that our platform and the information and services on our platform
                ...
                <p>
                  We will not be liable to you in respect of any special, indirect or consequential
                  loss or damage.
                </p>
              </ol>
            </div>
            ...
            <div id="variation" className="show-more">
              ...
              <ol>
                ...
                <p>
                  The revised terms and conditions shall apply to the use of our platform from the
                  date of publication of the revised terms and conditions on the platform, and you
            ...
            <div id="severability" className="show-more">
              ...
              <ol>
                ...
                <p>
                  ...
                  be lawful or enforceable if part of it were deleted, that part will be deemed to
            ...
            <div id="tpr" className="show-more">
              ...
              <ol>
                <p>
                  A contract under these terms and conditions is for our benefit and your benefit,
                ...
                <p>
                  Our platform allows users to use the services of some third party applications
                  such as Google maps or Open Street Map. When using these services users are bound
                  by the providers Terms and Conditions and AirQo accepts no liability for user
                  breech of these terms and conditions or the performance of these services.
                </p>
              </ol>
            </div>
            <div id="ea" className="show-more">
              ...
              <ol>
                <p>
                  ...
                  relation to your use of our platform and shall supersede all previous agreements
                  between you and us in relation to your use of our platform.
                </p>
              </ol>
            </div>
            ...
            <div id="details" className="show-more">
              ...
              <ol>
                <p>
                  This platform is owned and operated by College of Computing and Information
                  Sciences, Makerere University, Kampala, Uganda.
                </p>
                <p>
                  Our principal place of business is at Software Systems Centre, Block B, Level 3,
                  College of Computing and Information Sciences, Plot 56 University Pool Road
