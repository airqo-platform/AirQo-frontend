        ...
        <div className="tos-sub">
          ...
          <div className="tos-wording">
            <div id="intro" className="show-first">
              ...
              <ol>
                <li>
                  Some cities already have programs for air quality monitoring,
                  so we collaborate with them on how to increase their coverage
                  network.{' '}
                </li>
                <li>
                ...
                <li>
                  ...
                  platform or use any of our platform services, we will ask you
                  to expressly agree to these terms and conditions.
                </li>
                <li>
                  Our platform uses cookies; by using our platform or agreeing
            ...
            <div id="copyright" className="show-first">
              ...
              <ol>
                ...
                <li>
                  Subject to the express provisions of these terms and
                  conditions:
                </li>
                <p>
                  a. We, together with our licensors, own and control all the
                  copyright and other intellectual property rights in our
                  platform and the material on our platform; and
                </p>
                <p>
                  b. All the copyright and other intellectual property rights in
                  our platform and the material on our platform are reserved.
                </p>
              </ol>
            </div>
            <div id="ltup" className="show-first">
              ...
              <ol>
                ...
                <li>
                  ...
                  results, displays, or products must indicate that these data
                  are indicative and not fully verified or validated;
                </li>
                <li>
                  Publications, analyses, products, presentations, and/or
                  derived information that rely on these data must give
                  attribution to the originating data provider named on the data
                  as well as AirQo, subject to the other provisions of these
                  terms and conditions.
                </li>

                <p>
                  <b>
                    4.2 You may only use our platform for your own personal use,
                  </b>{' '}
                  academic research, government policy research and development,
                  charitable and public awareness raising, and you must not use
                  our platform for any other purposes.
                </p>

                <p>
                  <b>
                    4.4 Except as expressly permitted by these terms and
                    conditions,
                  </b>{' '}
                ...
                <p>
                  ...
                  <br />
                  republish material from our platform (including republication
                  on another platform); sell, rent or sub-license material from
                  our platform; or exploit material from our platform for a
                  commercial purpose.
                </p>

                <p>
                  <b>4.6 Notwithstanding Section 4.5,</b> you may redistribute
                  our newsletter or blog posts in print and electronic form to
                  any person.
                </p>
                ...
                <p>
                  ...
                  access restriction measures on our platform.
                </p>
              </ol>
            </div>
            <div id="au" className="show-first">
              ...
              <ol>
                ...
                <li>
                  use our platform in any way or take any action that causes, or
                  may cause, damage to the platform or impairment of the
                  performance, availability or accessibility of the platform;
                </li>
                <li>
                  use our platform in any way that is unlawful, illegal,
                ...
                <li>
                  ...
                  platform without our express written consent or via registered
                  use of our API or other data export, visualisation export or
                  reporting tools provided for this purpose on our platform.
                </li>
                <li>
            ...
            <div id="raa" className="show-first">
              ...
              <ol>
                <li>
                  You may register for an account with our platform by
                  completing and submitting the account registration form on our
                  platform, and clicking on the verification link in the email
                  that the platform will send to you.
                </li>
                <li>
                  You must ensure that all the information you supply to us
                  through our platform in relation to your intended use of our
                  content and your affiliations is true, accurate, current,
                ...
                <li>
                  You must notify us in writing immediately if you become aware
            ...
            <div id="uld" className="show-first">
              ...
              <ol>
                <li>
                  If you register for an account with our platform, we will
                ...
                <li>
                  You are responsible for any activity on our platform arising
            ...
            <div id="ycl" className="show-more">
              ...
              <ol>
                ...
                <li>
                  ...
                  giving rise to legal action against any person (in each case
            ...
            <div id="lw" className="show-more">
              ...
              <ol>
                <li>
                  ...
                  our platform. The data available on the platform are
                  indicative and while efforts are made to provide accurate data
                  they are not fully verified or validated; these data are
                  subject to change, error, and correction. The data and
                  information are not presented as an official record
                  <br />
                  <br />
                  the functionality or reliability of products in development
                  and labelled as ‘beta’ versions which are released for trial
                ...
                <li>
                  ...
                  platform services, and to stop publishing our platform, at any
                  ...
                  platform services, or if we stop publishing the platform.
                </li>
                <li>
                  ...
                  our platform and the use of our platform.
                </li>
              </ol>
            </div>
            <div id="lae" className="show-more">
              ...
              <ol>
                ...
                <p>
                  To the extent that our platform and the information and
                  services on our platform are provided free of charge, we will
            ...
            <div id="botc" className="show-more">
              ...
              <ol>
                ...
                <li>
                  ...
                  request that they block your access to our platform;
                </li>
                <li>
            ...
            <div id="variation" className="show-more">
              ...
              <ol>
                ...
                <p>
                  ...
                  conditions on the platform, and you hereby waive any right you
            ...
            <div id="tpr" className="show-more">
              ...
              <ol>
                ...
                <p>
                  Our platform allows users to use the services of some third
                  party applications such as Google maps or Open Street Map.
                  When using these services users are bound by the providers
                  Terms and Conditions and AirQo accepts no liability for user
                  breech of these terms and conditions or the performance of
                  these services.
                </p>
              </ol>
            </div>
            <div id="ea" className="show-more">
              ...
              <ol>
                <p>
                  ...
                  with our privacy and cookies policy, shall constitute the
                  entire agreement between you and us in relation to your use of
                  our platform and shall supersede all previous agreements
            ...
            <div id="details" className="show-more">
              ...
              <ol>
                <p>
                  This platform is owned and operated by College of Computing
                  and Information Sciences, Makerere University, Kampala,
                  Uganda.
                </p>
                <p>
                  Our principal place of business is at Software Systems Centre,
                  Block B, Level 3, College of Computing and Information
                  Sciences, Plot 56 University Pool Road Makerere University,
                  Kampala, Uganda.
                </p>
