                ...
                <div className='page-container'>
                    <div className="hero">
                        ...
                        <h3 className="header-3">
                            We harness the value that comes with bringing together community members passionate about
                    ...
                    <div className="community_wrapper">
                        ...
                        <div className="lower-banner">
                            <img src={AirQoQuotes} />
                            <h2>
                                We advocate for road safety and environmental protection from pollution associated with
                                the transport industry, and depend a lot on the AirQo platform to get air quality data
                                in order to extend air quality education to the communities.
                            </h2>
