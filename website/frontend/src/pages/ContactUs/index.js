                ...
                <div className="left-section">
                    <div className="section-container">
                        <div className="content">
                            ...
                            <span id="_2">
                                <p>
                                    Software Systems Centre, Block B, Level 3, College of Computing and Information
                                    Sciences, Plot 56 University Pool Road. Kampala, Uganda
                                </p>
                            </span>
                            <span id="_3">
                                <p>
                                    E:{' '}
                                    <a href="mailto:info@airqo.net?subject=Mail from AirQo Website">info@airqo.net</a>
                                </p>
                            </span>
                        </div>
                    </div>
