  ...
  return (
        <div className="Hero">
            ...
            <div className="hero-content">
                <div>
                <p className="hero-title">Clean air for <br />all African countries</p>

                <p className="hero-sub"> <span className='fact'>9 out of 10 people breathe polluted air</span> <br/>We give communities accurate, hyperlocal, and timely air quality data to take action against air pollution</p>
