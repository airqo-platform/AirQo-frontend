...
export const getAirQloudSummaryApi = async () =>
    await axios.get(AIRQLOUD_SUMMARY, { params }).then((response) => response.data);
...
// Careers endpoints
export const getAllCareersApi = async () => await axios.get(CAREERS_URL, { params }).then((response) => response.data);

export const getAllDepartmentsApi = async () =>
    await axios.get(DEPARTMENTS_URL, { params }).then((response) => response.data);

// Teams endpoints
export const getAllTeamMembersApi = async () =>
    await axios.get(TEAMS_URL, { params }).then((response) => response.data);

// Highlights endpoints
export const getAllHighlightsApi = async () =>
    await axios.get(HIGHLIGHTS_URL, { params }).then((response) => response.data);
export const getAllTagsApi = async () => await axios.get(TAGS_URL, { params }).then((response) => response.data);
