              ...
              <form>
                ...
                <label>
                  <input
                    ...
                    onChange={this.handleMagnitudeChange}
                  />
                  <div class="control__indicator2" data-tip data-for="moderate">12.1 - 35.4</div>
                ...
                <label>
                  <input
                    ...
                    onChange={this.handleMagnitudeChange}
                  />
                  <div class="control__indicator3" data-tip data-for="UHFSG">35.5 - 55.4</div>
                  <ReactTooltip id="UHFSG" place="right" effect="solid">
                   <h3 style={{fontWeight:"normal" }}> Unhealthy for sensitive groups</h3> 
                ...
                <label>
                  <input
                    ...
                    onChange={this.handleMagnitudeChange}
                  />
                  <div class="control__indicator4" data-tip data-for="unhealthy">55.5 - 150.4</div>
                ...
                <label>
                  <input
                    ...
                    onChange={this.handleMagnitudeChange}
                  />
                  <div class="control__indicator5" data-tip data-for="veryunhealthy">150.5 - 250.4</div>
                ...
                <label>
                  <input
                    ...
                    onChange={this.handleMagnitudeChange}
                  />
                  <div class="control__indicator6" data-tip data-for="harzadous">250.5 - 500</div>
