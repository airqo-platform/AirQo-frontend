...
const devConfig = {
    ...
    REGISTER_CANDIDATE_URI: 'http://localhost:3000/api/v1/users/register/candidate',
...
const stageConfig = {
    ...
    REGISTER_CANDIDATE_URI: 'https://airqo-250220.uc.r.appspot.com/api/v1/users/register/candidate',
    ...
    GET_CANDIDATES_URI: 'https://airqo-250220.uc.r.appspot.com/api/v1/users/candidates/fetch',
