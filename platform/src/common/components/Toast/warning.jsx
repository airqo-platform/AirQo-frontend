const ToastWarning = ({ message }) => (
  <div
    id='toast-warning'
    class='absolute bottom-0 right-6 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white-900 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800'
    role='alert'
  >
