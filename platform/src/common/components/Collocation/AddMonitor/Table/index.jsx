    ...
    <div className='border-r border-grey-150 col-span-2 gap-0 pt-6'>
      ...
      <div className='flex justify-between items-center flex-wrap md:flex-nowrap w-full px-6 pb-6'>
        ...
        <div className='flex justify-end items-center w-full'>
          <Button
            className={
              'h-9 w-full max-w-[114px] bg-[#0000000A] rounded-[4px] text-black font-medium text-sm mr-2'
            }
          >
            <div className='mr-1'>
              <FilterIcon />
          ...
          <div className='dropdown'>
            <Button
              tabIndex={0}
              className={
                'h-9 w-auto bg-[#0000000A] rounded-[4px] text-black font-medium text-sm mb-1'
              }
            >
              <div className='mr-1'>
                <SortByAlphaIcon />
