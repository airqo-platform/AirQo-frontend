...
class HealthRecommendationSection extends StatefulWidget {
  HealthRecommendationSection(
      {Key? key, required this.measurement}) : super(key: key);
...
class _HealthRecommendationSectionState extends
State<HealthRecommendationSection> {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) =>
                      Card(
                        ...
                        ColorConstants.appColor : Colors.white,
