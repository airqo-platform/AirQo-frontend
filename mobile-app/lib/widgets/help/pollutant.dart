  ...
  Future<void> _launchURL() async {
    try {
      await canLaunch(Links.referenceUrl)
          ...
          : throw Exception('Could not launch reference,'
...
class PollutantDialogV2 extends StatelessWidget {
  final Pollutant pollutant;

  PollutantDialogV2(this.pollutant);
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Padding(
            padding: const EdgeInsets.all(5),
            child: Text('What is ${pollutant.pollutant}?',
                softWrap: true,
                style: TextStyle(
                    fontSize: 17,
                    fontWeight: FontWeight.bold,
