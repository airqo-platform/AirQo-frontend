...
const getDevices = 'http://staging-platform.airqo.net/api/v1/devices?tenant=airqo';
const getDevice = 'http://staging-platform.airqo.net/api/v1/devices?tenant=airqo&name=';
