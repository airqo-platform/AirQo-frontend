...
import { VIEW_LOCATION_URI } from "config/urls/locationRegistry";
...
const LocationView = (props) => {
  ...
  useEffect(() => {
    setIsLoading(true);
    axios
      .get(VIEW_LOCATION_URI + params.loc_ref)
      .then((res) => {
        setIsLoading(false);
        const data = res.data;
        console.log(data);
                ...
                {loaded ? (
                  ...
                  >
                    ...
                    <Marker position={[locData.latitude, locData.longitude]}>
                      <Popup>
                        <span>
                          <span>{locData.location_name}</span>
                        </span>
                      </Popup>
                    </Marker>
                  </Map>
          ...
          <Grid item lg={12} md={12} sm={12} xl={12} xs={12}>
            <TableContainer component={Paper} className={classes.table}>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className={classes.table}>
                      Host Ref: <b>{locData.host}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      District: <b>{locData.district}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Aspect: <b>{locData.aspect}</b>
                    </TableCell>
                    {/*
              ...
              <TableCell className = {classes.table}>Altitude: <b>{locData.altitude}</b></TableCell>*/}
                  ...
                  <TableRow>
                    <TableCell className={classes.table}>
                      Mobility: <b>{locData.mobility}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Subcounty: <b>{locData.subcounty}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Landform (90): <b>{locData.landform_90}</b>
                    </TableCell>
                    {/* 
              ...
              <TableCell className = {classes.table}>Aspect: <b>{locData.aspect}</b></TableCell>   */}
                  ...
                  <TableRow>
                    <TableCell className={classes.table}>
                      Latitude: <b>{locData.latitude}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Parish: <b>{locData.parish}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Landform (270): <b>{locData.landform_270}</b>
                    </TableCell>
                    {/* 
              ...
              <TableCell className = {classes.table}>Landform (90): <b>{locData.landform_90}</b></TableCell>  */}
                  ...
                  <TableRow>
                    <TableCell className={classes.table}>
                      Longitude: <b>{locData.longitude}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Road Intensity: <b>{locData.road_intensity}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Distance to nearest road (m):{" "}
                      <b>{locData.distance_from_nearest_road}</b>
                    </TableCell>
                    {/* 
              ...
              <TableCell className = {classes.table}>Landform (270): <b>{locData.landform_270}</b></TableCell>   */}
                  ...
                  <TableRow>
                    <TableCell className={classes.table}>
                      Description: <b>{locData.description}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Road Status: <b>{locData.road_status}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Distance to nearest residential road (m):{" "}
                      <b>{locData.distance_from_residential}</b>
                    </TableCell>
                    {/*
              ...
              <TableCell className = {classes.table}>Distance to nearest road (m): <b>{locData.distance_from_nearest_road}</b></TableCell> */}
                  ...
                  <TableRow>
                    <TableCell className={classes.table}>
                      Country: <b>{locData.country}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Altitude: <b>{locData.altitude}</b>
                    </TableCell>
                    <TableCell className={classes.table}>
                      Distance to nearest motorway (m):{" "}
                      <b>{locData.distance_from_motorway}</b>
                    </TableCell>
                    {/*
                  ...
                  <TableRow>
                    ...
                    {loaded ? (
                      <TableCell className={classes.table}>
                        Local Activities:{" "}
                        <b>
                          {locData.local_activities &&
                            locData.local_activities.join()}
                        </b>
                      </TableCell>
                    ) : (
                      <TableCell className={classes.table}>
                        Local Activities: <b>{locData.local_activities}</b>
                      </TableCell>
                    )}
                    <TableCell className={classes.table}>
                      Distance to nearest city/town (m):{" "}
                      <b>{locData.distance_from_city}</b>
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
