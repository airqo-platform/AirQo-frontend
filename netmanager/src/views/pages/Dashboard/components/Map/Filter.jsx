          ...
          <form style={{ margin: '10px 0' }}>
            ...
            <label>
              ...
              <ReactTooltip id="UHFSG" place="right" effect="solid">
                <popup_a style={{ fontWeight: 'normal' }}> Unhealthy for sensitive groups</popup_a>
              </ReactTooltip>
            </label>
            <label>
            ...
            <label>
              ...
              <div className="control__indicator control__indicator6" data-tip data-for="harzadous">
                {harzardous}
              </div>
