...
// import "netmanager/src/assets/scss/report.css";
...
class Main extends Component {
  ...
  handlePrevSavedOpen = () => {
    axios
      .get(constants.GET_MONTHLY_REPORT_URI + this.state.user_id)
      .then((res) => {
  ...
  onDraftDelete = (report_id, report_name) => {
    // make api call to save report
    axios
      .delete(constants.DELETE_MONTHLY_REPORT_URI + report_name)
      .then((res) => {
        console.log(res.data);
        this.setState({ response_msg: res.data.message });
        this.setState({ openConfirm: true }); //
  ...
  onUpdateDraft = () => {
    axios
      .post(
        constants.UPDATE_MONTHLY_REPORT_URI + this.state.report_name,
        {
