...
export const UPDATE_SINGLE_MAINTENANCE_LOGS_SUCCESS =
  "UPDATE_SINGLE_MAINTENANCE_LOGS_SUCCESS";
export const UPDATE_SINGLE_MAINTENANCE_LOGS_FAILURE =
  "UPDATE_SINGLE_MAINTENANCE_LOGS_FAILURE";

export const DELETE_SINGLE_MAINTENANCE_LOGS_SUCCESS =
  "DELETE_SINGLE_MAINTENANCE_LOGS_SUCCESS";
export const DELETE_SINGLE_MAINTENANCE_LOGS_FAILURE =
  "DELETE_SINGLE_MAINTENANCE_LOGS_FAILURE";
...
export const UPDATE_SINGLE_COMPONENT_SUCCESS =
  "UPDATE_SINGLE_COMPONENT_SUCCESS";
export const UPDATE_SINGLE_COMPONENT_FAILURE =
  "UPDATE_SINGLE_COMPONENT_FAILURE";
