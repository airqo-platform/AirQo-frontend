...
export class MembersPage extends BasePage {
  ...
  protected static readonly SEND_INVITES = By.xpath(
    "//button[contains(text(), 'Send Invites')]"
  );
  protected static readonly ACTION_MENU = By.css('table tbody tr button');
  protected static readonly VIEW_DETAILS = By.xpath(
    "//div[contains(@role, 'menuitem')][contains(text(), 'View Details')]"
  );
  protected static readonly INVITE_DIALOG = By.xpath(
    "//div[contains(@role, 'dialog')]"
  );
  protected static readonly EMAIL_INPUT_DIALOG = By.css(
    'div[role="dialog"] input[type="email"]'
  );
  protected static readonly ADD_EMAIL = By.xpath(
    "//div[contains(@role, 'dialog')]//button[contains(text(), 'Add Email')]"
  );
  protected static readonly SEND_INVITES_SUBMIT = By.xpath(
    "//div[contains(@role, 'dialog')]//button[contains(text(), 'Send Invites')]"
  );
  protected static readonly CANCEL = By.xpath(
    "//div[contains(@role, 'dialog')]//button[contains(text(), 'Cancel')]"
  );
