...
export class ForgotPasswordPage extends BasePage {
  ...
  protected static readonly SUCCESS_TEXT = By.xpath(
    "//p[contains(text(), 'Password reset email sent successfully')]"
  );
  protected static readonly TRY_AGAIN_BUTTON = By.xpath(
    "//button[contains(text(), 'Try Again')]"
  );
  protected static readonly LOGIN_LINK = By.xpath(
