...
export class HomePage extends BasePage {
  private static readonly WELCOME_HEADING = By.css("h1");
  private static readonly DOWNLOAD_DATA = By.xpath("//a[contains(., 'Download Data')]|//button[contains(., 'Download Data')]");
  private static readonly MY_FAVORITES = By.xpath("//a[contains(., 'My Favorites')]|//button[contains(., 'My Favorites')]");
  private static readonly REQUEST_ORG = By.xpath("//a[contains(., 'Request New Organization')]|//button[contains(., 'Request New Organization')]");
  private static readonly DATA_ACCESS = By.xpath("//a[contains(., 'Data Access')]|//button[contains(., 'Data Access')]");
  private static readonly START_HERE = By.css('[data-testid="get-started-button"]');
  private static readonly SHOW_VIDEO = By.css('[data-testid="show-video-button"]');
  private static readonly VIDEO_THUMBNAIL = By.css('[data-testid="video-thumbnail"]');
