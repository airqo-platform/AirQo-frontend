      ...
      >
        <thead>
          <tr className="text-black text-xs border-y border-y-secondary-neutral-light-100 bg-secondary-neutral-light-25">
            <th
              scope="col"
              className="font-medium w-[175px] px-4 py-3 opacity-40"
            >
              Name
            </th>
            <th
              scope="col"
              className="font-medium w-[118px] px-4 py-3 opacity-40"
            >
              Status
            </th>
            <th
            ...
            <th
              scope="col"
              className="font-medium w-[140px] px-4 py-3 opacity-40"
            >
              Job title
            </th>
            <th
              scope="col"
              className="font-medium w-[110px] px-4 py-3 opacity-40"
            >
              Role
            </th>
          </tr>
