...
import { MAX_FAVORITES, MESSAGE_TYPES } from './constants';

export const AddFavorites = ({ onClose }) => {
  ...
  const handleSubmit = useCallback(() => {
    if (!selectedSites.length) {
      setError('Please select at least one location to add to your favorites.');
  ...
  return (
    <ErrorBoundary name="AddFavorites" feature="Add Favorite Locations">
      <motion.div
        ...
        animate="animate"
        exit="exit"
        data-testid="add-favorites-container"
      >
        {/* Desktop Sidebar */}
        ...
        <div className="flex-1 flex flex-col relative overflow-hidden min-h-0">
          ...
          <EnhancedFooter
            btnText={submitLoading ? 'Saving...' : 'Save Favorites'}
            setError={setError}
