...
export class HomePage extends BasePage {
  ...
  protected static readonly DATA_ACCESS = By.xpath(
    "//a[contains(., 'Data Access')]|//button[contains(., 'Data Access')]"
  );
  protected static readonly START_HERE = By.css(
    '[data-testid="get-started-button"]'
  );
  protected static readonly SHOW_VIDEO = By.css(
    '[data-testid="show-video-button"]'
  );
  protected static readonly VIDEO_THUMBNAIL = By.css(
