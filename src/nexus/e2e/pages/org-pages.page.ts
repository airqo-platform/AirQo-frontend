...
export class OrgSettingsPage extends BasePage {
  protected static readonly THEME_TAB = By.xpath(
    "//button[contains(., 'Theme')]"
  );
  protected static readonly GROUP_DETAILS_TAB = By.xpath(
    "//button[contains(., 'Group Details')]"
  );
...
export class OrgRolesPage extends BasePage {
  ...
  protected static readonly CREATE_ROLE_BUTTON = By.xpath(
    "//button[contains(., 'Create New Role') or contains(., 'Create')]"
  );
  ...
  protected static readonly ROLE_DIALOG = By.xpath(
    "//div[contains(@role, 'dialog')]"
  );
  protected static readonly ROLE_NAME_INPUT = By.css(
    'div[role="dialog"] input'
  );
  protected static readonly DIALOG_SUBMIT = By.xpath(
    "//div[contains(@role, 'dialog')]//button[contains(text(), 'Create') or contains(text(), 'Save')]"
  );
  protected static readonly PERMISSION_COUNT = By.css(
    'table tbody tr td:nth-child(2)'
  );
  protected static readonly USER_COUNT = By.css(
...
export class MemberRequestsPage extends BasePage {
  protected static readonly PAGE_TITLE = By.xpath(
    "//h1[contains(text(), 'MEMBER REQUESTS') or contains(text(), 'Member Requests')]"
  );
  protected static readonly REQUESTS_TABLE = By.css('table');
  protected static readonly APPROVE_BUTTON = By.xpath(
    "//button[contains(text(), 'Approve')]"
  );
  protected static readonly REJECT_BUTTON = By.xpath(
    "//button[contains(text(), 'Reject')]"
  );
  protected static readonly TABS = By.css(
    "nav button, [role='tablist'] button"
  );
  protected static readonly STATUS_BADGE = By.css(
    "[class*='badge'], [class*='status']"
  );
  protected static readonly CONFIRM_DIALOG = By.xpath(
    "//div[contains(@role, 'dialog')]"
  );
  protected static readonly CONFIRM_APPROVE = By.xpath(
    "//div[contains(@role, 'dialog')]//button[contains(text(), 'Approve')]"
  );
  protected static readonly CONFIRM_REJECT = By.xpath(
    "//div[contains(@role, 'dialog')]//button[contains(text(), 'Reject')]"
  );
  protected static readonly REJECT_REASON = By.css(
    'div[role="dialog"] textarea, div[role="dialog"] input'
  );
