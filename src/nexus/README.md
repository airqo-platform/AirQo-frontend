...
**Nexus** is the AirQo analytics application for air quality monitoring, data visualization, device management, and analytics. Built with Next.js 14 (App Router), React 18, and TypeScript.
