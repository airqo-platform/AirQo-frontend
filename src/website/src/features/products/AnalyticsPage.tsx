        ...
        >
          ...
          <motion.div className="space-y-6" variants={itemVariants}>
            ...
            <p className="text-[18px] text-gray-700">
              If we can&apos;t measure air pollution, we can&apos;t manage it:
              Access, track, analyse and download insightful air quality data
              across major cities in Africa.
            </p>
          </motion.div>
      ...
      >
        <div className={`${mainConfig.containerClass} space-y-8`}>
          ...
          >
            ...
            <CustomButton
              onClick={() => window.open('https://nexus.airqo.net/', '_blank')}
