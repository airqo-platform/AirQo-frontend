...
import MaintenanceBanner from '../MaintenanceBanner/page';

import { setOpenModal } from '@/lib/services/downloadModal';
...
const Layout = ({
  ...
  const isCollapsed = useDis((state) => state.sidebar.isCollapsed);
  const isOpen = useAppSelector((state) => state.modal.openModal);
