...
export const METADATA_CONFIGS = {
  ...
  solutionsMonitorCoverage: {
    title:
      'Monitor Coverage Map | AirQo Network Across Africa - 200+ Active Stations',
    description:
    ...
    keywords:
      'AirQo monitor coverage, air quality network map, monitoring stations Africa, sensor locations, coverage map, monitor deployment, African cities coverage, real-time monitoring network, sensor distribution, air quality infrastructure',
    url: '/solutions/monitor-coverage',
    image: {
      url: 'https://res.cloudinary.com/dbibjvyhm/image/upload/v1742912754/website/photos/Screenshot_2025-03-25_172412_amk2tl.png',
      alt: 'AirQo Monitor Coverage Map - 200+ Stations Across Africa',
      width: 1200,
      height: 630,
      type: 'image/png',
    },
