...
class _TimeWindowSheetState extends State<TimeWindowSheet> {
  ...
  String get _hint {
    ...
    return '${w.durationLabel} window at ${widget.place.type.label.toLowerCase()}';
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Set your typical schedule to track exposure accurately.',
                          style: TextStyle(fontSize: 13, color: AppColors.boldHeadlineColor)),
                      ...
                      Center(child: Text(_hint, style: TextStyle(fontSize: 13, color: AppColors.boldHeadlineColor, fontWeight: FontWeight.w500))),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isDark ? const Color(0xFF2E2F33) : AppColors.highlightColor,
