...
| Spatial heatmaps | ✅ | ✅ | ✅ |
| Historical data (multi-year; up to 365 days per request) | ❌ | ✅ | ✅ |
| Raw sensor data | ❌ | ✅ | ✅ |
| Daily aggregations | ❌ | ✅ | ✅ |
| Bulk data exports | ❌ | ✅ | ✅ |
...
- Full historical data access (multi-year history; each request covers up to 365 days, use batches for longer ranges)
