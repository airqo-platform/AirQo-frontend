...
The Data Export page lets you download air quality datasets from Nexus. Select locations across Africa, configure date ranges and pollutants, and export in multiple formats for offline analysis.

---

## Accessing the Export Page

1. Log in to [Nexus](https://analytics.airqo.net).
