...
The AirQo RBAC (Role-Based Access Control) system provides comprehensive access control for the digital platforms. Users can belong to multiple organizations (Groups and Networks) with different roles and permissions in each.
