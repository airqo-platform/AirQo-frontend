...
Select the menu icon in the header to open the global sidebar. This panel provides cross-workflow navigation:

- **Home** — takes you to the appropriate home page for your current workflow
- **Data Access** — opens the platform data access page
