...
class Config {
  ...
  static String get airqoApiUrlV2 => dotenv.env['airqoApiUrlV2'] ?? '';
  static String get alertsCollection => dotenv.env['ALERTS_COLLECTION'] ?? '';
  static String get appAndroidWhatsappUrl => dotenv.env['ANDROID_WHATSAPP_URL'] ?? '';
  ...
  static String get appErrorMessage => 'Failed to process your request. Try again later';
