...
class ReadingsCardV2 extends StatefulWidget {
  final Site site;
  ...
  @override
  _ReadingsCardStateV2 createState() =>
      _ReadingsCardStateV2(site, historicalData);
}
...
class _ReadingsCardStateV2 extends State<ReadingsCardV2> {
  final List<charts.Series> gaugeSeriesList = _createSampleData();
  final List<charts.Series<TimeSeriesData, DateTime>> graphSeriesList =
      createData();
