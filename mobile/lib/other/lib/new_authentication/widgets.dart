...
class NextButtonLogin extends StatelessWidget {
...
class NextButtonSignup extends StatelessWidget {
  const NextButtonSignup({
    super.key,
    this.buttonColor,
    this.textColor,
    required this.callBack,
...
class EmailEditFieldLogin extends StatelessWidget {
  const EmailEditFieldLogin({
    super.key,
    required this.label,
    required this.valueChange,
    required this.hintText,
...
class EmailEditFieldSignup extends StatelessWidget {
  const EmailEditFieldSignup({
    super.key,
    required this.label,
    required this.valueChange,
    required this.hintText,
...
class PasswordEditFieldLogin extends StatefulWidget {
  const PasswordEditFieldLogin({
    super.key,
    required this.label,
    required this.valueChange,
    required this.hintText,
  ...
  @override
  State<PasswordEditFieldLogin> createState() => _PasswordEditFieldLoginState();
}

class _PasswordEditFieldLoginState extends State<PasswordEditFieldLogin> {
...
class PasswordEditFieldSignup extends StatefulWidget {
  const PasswordEditFieldSignup({
    super.key,
    required this.label,
    required this.valueChange,
    required this.hintText,
  ...
  @override
  State<PasswordEditFieldSignup> createState() =>
      _PasswordEditFieldSignupState();
}

class _PasswordEditFieldSignupState extends State<PasswordEditFieldSignup> {
  bool passwordVisible = false;
  @override
  void initState() {
    super.initState();
