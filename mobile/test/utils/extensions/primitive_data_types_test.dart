  ...
  void main() {
    ...
    group('DateTime Extension', () {
      ...
      test('analyticsCardString returns correct string for yesterday', () {
        ...
        String expected3 =
            'Tomorrow, ${DateFormat('hh:mm a').format(tomorrow)}';
      ...
      test(
        ...
        expect(
            fixedDate1.add(const Duration(days: 7)).getDateOfFirstDayOfWeek(),
      ...
      test('getMonthString should return the month name or abbreviation', () {
        ...
        expect(
            fixedDate1.add(const Duration(days: 31)).getMonthString(), 'June');
      });
      ...
      test('isWithInCurrentWeek returns true for dates within the current week',
        ...
        expect(today.subtract(const Duration(days: 7)).isWithInCurrentWeek(),
            isFalse);
        expect(
            today.add(const Duration(days: 7)).isWithInCurrentWeek(), isFalse);
      });
      ...
      test(
        ...
        expect(
            today
                .subtract(Duration(days: 7 + today.weekday))
                .isWithInNextWeek(),
            isFalse);
      });
