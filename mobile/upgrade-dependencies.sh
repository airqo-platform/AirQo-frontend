...
flutter pub add shimmer google_fonts in_app_review sentry_flutter lottie
...
flutter pub add firebase_in_app_messaging permission_handler firebase_crashlytics workmanager flutter_cache_manager
