                 ...
                 <div class="col-md-12">
                     <div class="portlet box blue">
                         <div class="portlet-title">
                             <div class="caption">
                                 <i class="fa fa-tasks"></i>Add New Post
                             </div>
                             <div class="tools">
                         ...
                         <div class="portlet-body form">
                             <?php
                                ...
                                ?>
                             <!-- BEGIN FORM-->
                             <form action="<?= site_url('a-add-post'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                 <div class="form-body">
                                     <div class="form-group">
                                         <label class="col-md-3 control-label">Post Title</label>
                                         <div class="col-md-8">
                                             <input type="text" class="form-control" name="post_title" value="<?= set_value('post_title'); ?>" placeholder="Post Title">
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         ...
                                         <div class="col-md-4">
                                             ...
                                             <input type="text" id="fb_downloadURL" class="form-control" name="post_image" value="<?= set_value('post_image'); ?>" placeholder="Image Link" readonly/>
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label class="col-md-3 control-label">Image Caption</label>
                                         <div class="col-md-8">
                                             <input type="text" class="form-control" name="post_image_caption" value="<?= set_value('post_image_caption'); ?>" placeholder="Image Caption">
                                         </div>
                                     </div>
                                     <div class="form-group">
