						...
						<div class="kaboom">
							...
							<form name="form" method="post" action="<?php echo site_url('Admin/addContactInformation'); ?>" class="story_form" enctype="multipart/form-data">
								...
								<div class="form-group col-md-12">
									<textarea cols="10" rows="2" id="ckeditor3" class="summernote" name="con_address" required></textarea>
									<script type="text/javascript">
								...
								Information:
								<div class="form-group col-md-12">
									<textarea cols="10" rows="2" id="ckeditor4" class="summernote" name="con_info" required></textarea>
									<script type="text/javascript">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form name="form" method="post" action="<?php echo site_url('Admin/editContact'); ?>" enctype="multipart/form-data">
						...
						Address:
						<div class="form-group col-md-12">
							<textarea cols="10" rows="2" id="ckeditor1" name="con_address" class="summernote" required></textarea>
							<script type="text/javascript">
						...
						Information:
						<div class="form-group col-md-12">
							<textarea cols="10" rows="2" id="ckeditor2" name="con_info" class="summernote" required></textarea>
							<script type="text/javascript">
	...
	$('.edit_contact').on('show.bs.modal', function(e) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				$('#ckeditor1').summernote('code',data.c_address);
				$('#ckeditor2').summernote('code',data.c_infor);
