				...
				<div class="BuzenHomepage">
					<div class="kaboom">
										...
										?>
											...
											<td>
												...
												if(!empty($row['team_image'])) {
													echo '
													<img class="img_zero"  src="'. base_url().'assets/images/team/'.$row['team_image'].'" width="70px" height="70px;" alt="Team Member Image">
													';
												}else{
													echo '';
												}
						...
						<form name="form" method="post" action="<?php echo site_url('Admin/addMember');?>" class="addMember_form" enctype="multipart/form-data">
							...
							<div class="form-group col-md-12">
								<div class="row">
									<p><b class="col col-md-2 right">Add A Member Image:</b></p>
								</div>
						    </div>
								<div class="row">
								 	<div class="form-group col-md-12">
		                      ...
		                      <input class="btn btn-default" id="inputImage1" name="team_image" type="file" accept="image/*">
						 ...
						 <input class="form-control" type="hidden" id="team_id" name="team_id" placeholder="" />
							...
							<div class="form-group col-md-12">
									<div class="col-md-6">
										...
										<label class="btn btn-primary btn-upload" for="team_image" title="Upload image file">
												<input class="btn btn-default" id="team_image" name="team_image" type="file" accept="image/*" >
												<span class="docs-tooltip" data-toggle="tooltip" title="Select Image">
								...
								<script>
									var uploadField = document.getElementById("team_image");
