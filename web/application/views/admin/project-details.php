							...
							<div class="page-bar">
								<ul class="page-breadcrumb">
								    ...
								    <!-- <span class="pull-right"> -->
									 <li class="" >
										 <a href="<?php echo site_url('Admin/projects');?>" class='btn btn-success' id="Storybtn"  style="margin-left: 780px;" title="Back">
										...
										{
										?>
											<li class=""> <a data-toggle="modal" data-target=".edit_team" class="btn btn-warning" data-id="<?= $row['p_id']; ?>" id="actionbtn2" title="Edit"><i class="fa fa-edit (alias)"></i></a></li>

											<li>
											<a title="Delete" data-id="<?php echo $row['p_id'];?>" class="btn btn-danger actionbtn3 delete-btn" data-toggle="confirmation" data-placement="left" data-singleton="true" type="submit">
							...
							<div class="col-md-8">
							 <div id="info">
					          <div class="outline">
										...
										echo'
										<div class="">
										<h5 style="font-size:14px;"> <b> Title: </b> '.$row['p_title'].'</h5>
										</div>
										<div class="">
										<h5 style="font-size:14px;"> <b> Title: </b> '.$row['p_excerts'].'</h5>
										</div>

										<div class="form-group">
										<p> <b>Content:</b> </p>
											<textarea cols="20" rows="5" id="ckeditorr" class="summernote" name="p_content" placeholder=" Description">
												'.$row['p_content'].'
											</textarea>
										...
										<div class="col">
										<h4><b>Image:</b></h4>
										<img class="img_zero" src="'.base_url().'assets/images/projects/'.$row['p_image'].'" width="500px" height="100px" alt="Project Image ">
										</div>
										</div>
										...
										<p>&nbsp;</p>
										<div class="">
												<p> <b> Date Created: </b>'.$row['p_date'].' </p>
												<div>

												';
											if($row['p_updateDate'] == null)
													{
														echo '<p> <b> Last Updated: </b> <span style="color:brown; font-weight:bolder;">Not Updated Yet.!</span> </p>';
													}
													else if($row['p_updateDate'] == '0000-00-00 00:00:00')
													{
													echo '<p> <b> Last Updated: </b> <span style="color:brown; font-weight:bolder;">Not Updated Yet.!</span> </p>';	
													}
													else
													...
													{
														echo '
														<p> <b> Last Updated: </b>'.$row['p_updateDate'].' 
														    By: <span style="color:brown; font-weight:bolder;">'.$row['p_updatedBy'].'</span>
														</p>
														';
													}
												}
