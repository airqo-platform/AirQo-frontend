...
<head>
     <meta charset="utf-8" />
     <title><?= $title; ?> | AirQo - Admin Portal</title>
...
<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo  page-sidebar-fixed page-footer-fixed">
     ...
     <div class="page-header -i navbar navbar-fixed-top">
          ...
          <div class="page-header-inner">
               ...
               <div class="page-logo">
                    <a href="#">
                         <img src="<?= base_url(); ?>assets/frontend/images/logo.png" height="30px" width="100%" style="margin-top:5px;" alt="logo" class="logo-default" />
                    </a>
                         ...
                         <li class="dropdown dropdown-user">
                              ...
                              <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                   ...
                                   <span class="username username-hide-on-mobile">
                                        <?php if (isset($this->session->userdata['loggedin']['adminname'])) {
                                             echo substr($this->session->userdata['loggedin']['adminname'], 0, 10);
                                        } ?>... </span>
