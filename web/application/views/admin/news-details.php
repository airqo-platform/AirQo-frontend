							...
							<div class="page-bar">
								<ul class="page-breadcrumb">
								    ...
								    <!-- <span class="pull-right"> -->
									 <li class="" >
										 <a href="<?php echo site_url('Admin/news');?>" class='btn btn-success' id="Storybtn"  style="margin-left: 780px;" title="Back">
										...
										{
										?>
											<li class=""> <a data-toggle="modal" data-target=".edit_team" class="btn btn-warning" data-id="<?= $row['news_id']; ?>" id="actionbtn2" title="Edit"><i class="fa fa-edit (alias)"></i></a></li>

											<li>
											<a title="Delete" data-id="<?php echo $row['news_id'];?>" class="btn btn-danger actionbtn3 delete-btn" data-toggle="confirmation" data-placement="left" data-singleton="true" type="submit">
							...
							<div class="col-md-8">
							 <div id="info">
					          <div class="outline">
										...
										echo'
										<div class="">
										<h5 style="font-size:14px;"> <b> Title: </b> '.$row['news_title'].'</h5>
										</div>
										<div class="">
										<h5 style="font-size:14px;"> <b> Simple Description: </b> '.$row['news_excerts'].'</h5>
										</div>
										...
										<div class="col">
										<h4><b>Image:</b></h4>
										<img class="img_zero" src="'.base_url().'assets/images/news/'.$row['news_image'].'" width="500px" height="100px" alt="Project Image ">
										</div>
										</div>
										...
										<p>&nbsp;</p>
										<div class="">
												<p> <b> Date Created: </b>'.$row['news_dateAdded'].' </p>
												<div>

												';
											if($row['news_dateUpdated'] == null)
													{
														echo '<p> <b> Last Updated: </b> <span style="color:brown; font-weight:bolder;">Not Updated Yet.!</span> </p>';
													}
													else if($row['news_dateUpdated'] == '0000-00-00 00:00:00')
													{
													echo '<p> <b> Last Updated: </b> <span style="color:brown; font-weight:bolder;">Not Updated Yet.!</span> </p>';	
													}
													else
													...
													{
														echo '
														<p> <b> Last Updated: </b>'.$row['news_dateUpdated'].' 
														    By: <span style="color:brown; font-weight:bolder;">'.$row['news_updatedBy'].'</span>
														</p>
														';
													}
												}
