...
define('EVENTS_DATA', 'https://staging-platform.airqo.net/api/v1/devices/events?tenant=airqo&recent=yes&external=no');
...
define('REQUEST_DATA_ACCESS', 'https://staging-platform.airqo.net/request-access?tenant=airqo');
