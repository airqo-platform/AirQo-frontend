...
define('DEVICES_DATA', 'http://platform.airqo.net/api/v1/devices?tenant=airqo');
define('EVENTS_DATA', 'http://platform.airqo.net/api/v1/devices/events?tenant=airqo&recent=true');
