...
define('FORECAST_LINK', 'https://platform.airqo.net/api/v2/predict/');
...
define('DEVICES_DATA', 'https://platform.airqo.net/api/v1/devices?tenant=airqo');
#define('EVENTS_DATA', 'https://platform.airqo.net/api/v1/devices/events?tenant=airqo&recent=yes');
define('EVENTS_DATA', 'https://platform.airqo.net/api/v1/devices/events?tenant=airqo&recent=yes&frequency=hourly');
