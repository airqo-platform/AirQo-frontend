...
class ReadingsBarChart extends StatefulWidget {
  final List<charts.Series<TimeSeriesData, DateTime>> seriesList;
  final String header;
  final callback;

  ReadingsBarChart(this.seriesList, this.header, this.callback);

  @override
  _ReadingsBarChartState createState() => _ReadingsBarChartState();
}
        ...
        selectionModels: [
          charts.SelectionModelConfig(
            ...
            if (model.hasDatumSelection) {
              try {
                setState(() {
                  widget.callback((model.selectedSeries[0]
