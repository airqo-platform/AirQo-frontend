...
var SwipeableDrawer = React.forwardRef(function SwipeableDrawer(inProps, ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(_Drawer.default, (0, _extends2.default)({
    ...
    onClose: onClose,
    ref: ref
  }, other)), !disableSwipeToOpen && variant === 'temporary' && React.createElement(_NoSsr.default, null, React.createElement(_SwipeArea.default, (0, _extends2.default)({
    anchor: anchor,
    ref: swipeAreaRef,
